return {
    {
        ...
        config = function(_, opts)
            ...
            -- Auto-install and atart parsers for any buffer
    ...
    },
    {
        ...
        keys = {
            ...
            },
            {
                "if",
                function()
                    require("nvim-treesitter-textobjects.select").select_textobjects("@function.inner", "textobjects")
                end,
